                ...
                <div className="space-x-2 lg:block">
                    ...
                    <Link href="/logout" className="text-gray-800 dark:text-white font-medium text-sm px-2 lg:px-3 py-2 lg:py-2.5 mr-2 lg:mr-0 focus:outline-none">
                        ...
                        { !authStatus && (
                            ...
                            <Link href="/signup" className="hidden sm:inline-block text-gray-800 dark:text-white font-medium text-sm px-2 lg:px-3 py-2 lg:py-2.5 mr-2 lg:mr-0 focus:outline-none">
                                Signup
                            </Link> 
                                </>
                        )}
