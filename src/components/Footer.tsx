    ...
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <ul className="text-gray-500 font-medium dark:text-white">
                        ...
                        <li>
                            <Link href="https://www.linkedin.com/in/shaidislam/" className="hover:underline">
                                Linkedin
                            </Link>
                        </li>
                    </ul>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                <Link href="#" className="text-gray-500 hover:text-gray-900 dark:text-white">
                    <svg
                        className="w-4 h-4"
                        aria-hidden="true"
                ...
                <Link href="#" className="text-gray-500 dark:text-white">
                    <svg
                        className="w-4 h-4"
                        aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg"
